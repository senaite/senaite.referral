...
import senaite.referral.core.browser.dexterity
...
from senaite.referral.core.interfaces import ISenaiteFormLayer
from zope.browserpage.viewpagetemplatefile import ViewPageTemplateFile


def path(filepart):
    return os.path.join(
        os.path.dirname(senaite.referral.core.browser.dexterity.__file__),
        "templates",
        filepart,
    )
